...
function TableTwo(props: IProps) {
  const handleDeleteBlog = (id: number) => {
    if (confirm(`ban muon xoa id=${id})`)) {
      ...
      <div className="rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        ...
        {blogs?.map((item, key) => (
          ...
          >
            ...
            <div className="col-span-3 mx-3 hidden items-center sm:flex">
              <p className="max-h-20 overflow-auto text-body-sm font-medium text-dark dark:text-dark-6">
                {item.content}
              </p>
            </div>
            <div className="col-span-1 flex items-center">
              <p className="overflow-hidden overflow-ellipsis whitespace-nowrap text-body-sm font-medium text-dark dark:text-dark-6">
                {item.author}
              </p>
            </div>
